// Ported from hle-familyhub/lib/relationships.ts. Pure logic — kept as close
// to the legacy module as possible. The Prisma "Relationship" enum becomes a
// string-literal union matching the PG enum in migrations/0003_hub.sql.
...
export type Relationship = (typeof FAMILY_RELATIONSHIPS)[number]
 ...
 * Positive = target is a younger generation (child, below), negative = older
 * (parent, above).
 */
