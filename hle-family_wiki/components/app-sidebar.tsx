...
const workspaceNav = [
  ...
  { title: "Shared with Me", href: "/shared", icon: Share2 },
...
export function AppSidebar({ user, household, households }: {
  user: UserInfo;
  household: Household;
  ...
  return (
    <Sidebar>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger className="flex w-full items-center justify-between rounded-md px-2 py-1.5 text-sm hover:bg-sidebar-accent">
            <div className="text-left">
              ...
              <div className="text-xs text-muted-foreground">Family Wiki</div>
            </div>
      ...
      <SidebarContent>
        <NavGroup label="Wiki" items={wikiNav} pathname={pathname} />
        <NavGroup label="Workspaces" items={workspaceNav} pathname={pathname} />
      ...
      <SidebarFooter className="border-t p-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <form action={logoutAction}>
            <button type="submit" className="p-1.5 rounded-md hover:bg-sidebar-accent text-muted-foreground" title="Sign out">
